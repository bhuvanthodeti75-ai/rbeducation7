...
export const Footer = () => (
  <footer className="footer bg-white/[0.02] backdrop-blur-[20px] border-t border-white/[0.05] py-12 sm:py-14 px-6 sm:px-10 flex flex-col sm:flex-row justify-between items-center sm:items-start gap-10 relative z-10 text-center sm:text-left shadow-[0_-20px_50px_rgba(0,0,0,0.3)]">
    <div className="footer-left reveal">
      <div className="footer-brand font-bebas text-[2.2rem] sm:text-[2.5rem] tracking-[0.08em] text-[#E8E0CE] mb-2 sm:mb-3">RBEDUCATION <sup className="lowercase">©</sup></div>
      <p className="footer-copy text-[0.7rem] sm:text-[0.78rem] text-white/40 sm:text-white/50 leading-relaxed">© 2019–2026 RBEDUCATION.<br />All rights reserved.</p>
    </div>
    <div className="footer-right flex flex-col items-center sm:items-end gap-5 reveal">
      <a href="mailto:hello@rbeducation.com" className="footer-link text-[0.8rem] sm:text-[0.85rem] text-white/60 hover:text-[#C0B89A] transition-colors">hello@rbeducation.com</a>
